        ...
        <div className={styles.container}>
            <Grid container spacing={3} justify="center">
                ...
                <CardContent>
                    ...
                    <Typography colr="textSecoundar">{new Date(lastUpdate).toDateString()}</Typography>
                    <Typography variant="body2">Number of Infected from COVID19</Typography>
                    </CardContent> 
                </Grid>
                <Grid item component={Card} xs={12} md={3} className={cx(styles.card,styles.recovared)}>
                <CardContent>
                ...
                <CardContent>
                    ...
                    <Typography varaint="h5"><CountUp
                                                ...
                                                duration={2.5}
                                                separator=","/></Typography>
                    <Typography colr="textSecoundar">{deaths.value}</Typography>
